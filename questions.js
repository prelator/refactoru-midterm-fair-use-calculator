// ===================== ANGULAR QUESTION SERVICE =====================================
fairuseApp.factory('questionSvc', [function () {
  
//Extend array prototype methods: Add method to search array of objects by 'name' property
...
//================= MAIN VARIABLES =========================
  ...
  var currentQuestion = typeOfClaim;
    
  //Question counter default
  var questionCounter = 0;

  //Answerlist array default
  var answerList = [];

  //Dispute statements default
  var longStatements = {
    purpose: "",
    nature: "",
    amount: "",
...
//============== MAIN FUNCTIONS =========================
  ...
  //Question Lookup
  var findQuestion = function(qName) {
    return questionList.findByName(qName);
  };

  //Get current question tree
  ...
  //Get current long statements
  var getCurrentLongStatements = function() {
    return longStatements;
  };

  //Retrieve long statements from answerList
  ...
  var getCurrentWebformNotice = function() {
    return webformNotice;
  };
  ...
  var saveAnswer = function(qName, choice) {
...
//==================== SERVICE EXPORTS OBJECT ============================
  ...
  return {
    ...
    getQuestionTree: getQuestionTree,
    getCurrentLongStatements: getCurrentLongStatements,
    getCurrentWebformNotice: getCurrentWebformNotice,
    ...
    goBackOne: goBackOne,
    setLongStatements: setLongStatements,
    setWebformNotice: setWebformNotice
